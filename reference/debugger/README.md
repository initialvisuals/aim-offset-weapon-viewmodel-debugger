...
2. **Player controls** (panel closed) — WASD, Shift sprint, C crouch toggle / Ctrl crouch hold (slower move, no sprint, ducked eye height), mouse look, Q/E lean (full roll + lateral offset), tiny A/D strafe tilt only (~2.5% of lean max), RMB ADS, Space hold-breath, LMB fire.
